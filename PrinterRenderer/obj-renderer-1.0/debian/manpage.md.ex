% obj-renderer(SECTION) | User Commands
%
% "April 23 2024"
...
obj-renderer - program to do something

# SYNOPSIS

**obj-renderer** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**obj-renderer** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **obj-renderer** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**obj-renderer** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    obj-renderer. See **foo.conf**(5) for further details.
...
**obj-renderer** provides some return codes, that can be used in scripts:
